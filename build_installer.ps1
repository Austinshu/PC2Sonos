...
# --- 2. the app itself ----------------------------------------------
Write-Host "[2/4] Building PC2Sonos.exe..."
...
# --- 3. payload (app + unmodified VB-CABLE driver pack) --------------
Write-Host "[3/4] Assembling installer payload..."
...
# --- 4. the installer ------------------------------------------------
Write-Host "[4/4] Building PC2Sonos-Setup.exe..."
